...
requiere modulo de envio de email {
  -verifiar email debe enviar email al momento del registro
  -generar new password user de la misma cuenta olvido contraceña requiere controlador y servicio
}
*/
